...
The current green/`never-measured` count is **0**, and the current red/`measured-and-passed` count is **70**.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `green` | 0 | 644 | 0 | 3 | 202 | 849 |
| `red` | 43 | 70 | 11 | 0 | 30 | 154 |
...
| `backend-parity-c/aio-refusal` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/aio-refusal` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/aio-refusal` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/append-pwrite` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/append-pwrite` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/append-pwrite` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/bind-getsockname` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/bind-getsockname` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/bind-getsockname` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/cachestat-refusal` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/cachestat-refusal` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/cachestat-refusal` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/child-subreaper-refusal` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/child-subreaper-refusal` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/child-subreaper-refusal` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/close-range-fds` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/close-range-fds` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/close-range-fds` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/copy-file-range-refusal` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/copy-file-range-refusal` | `verify` | `liteinst` | `green` | `diverged` |
...
| `backend-parity-c/cpu-virtualization` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/cpu-virtualization` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/cpu-virtualization` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/cwd-roundtrip` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/cwd-roundtrip` | `verify` | `liteinst` | `green` | `diverged` |
...
| `backend-parity-c/dup-shared-offset` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/dup-shared-offset` | `verify` | `liteinst` | `green` | `diverged` |
...
| `backend-parity-c/epoll-pwait2` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/epoll-pwait2` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/epoll-readiness` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/epoll-readiness` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/epoll-readiness` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/event-delivery-ordering` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/event-delivery-ordering` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/eventfd-semantics` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/eventfd-semantics` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/eventfd-semantics` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/faccessat2-flags` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/faccessat2-flags` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/faccessat2-flags` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/fadvise-hints` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/fadvise-hints` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/fadvise-hints` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/fallocate-extents` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/fallocate-extents` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/fallocate-extents` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/fchmod-bits` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/fchmod-bits` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/fchmod-bits` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/fchmodat2-flags` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/fchmodat2-flags` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/fcntl-owner` | `verify` | `liteinst` | `green` | `diverged` |
...
| `backend-parity-c/fd-duplication` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/fd-duplication` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/fd-duplication` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/file-backed-mmap` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/file-backed-mmap` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/file-backed-mmap` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/file-io-roundtrip` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/file-io-roundtrip` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/file-io-roundtrip` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/flock-lifecycle` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/flock-lifecycle` | `verify` | `liteinst` | `green` | `diverged` |
...
| `backend-parity-c/fsync-durability` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/fsync-durability` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/ftruncate-sparse` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/ftruncate-sparse` | `verify` | `liteinst` | `green` | `diverged` |
...
| `backend-parity-c/getcpu-identity` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/getcpu-identity` | `verify` | `liteinst` | `green` | `diverged` |
...
| `backend-parity-c/getpriority-identity` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/getpriority-identity` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/getpriority-identity` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/getrusage-self-accounting` | `verify` | `liteinst` | `red` | `measured-no-verdict` |
| `backend-parity-c/getrusage-self-accounting` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/hardware-trap-identity` | `verify` | `dbt` | `red` | `measured-and-passed` |
| `backend-parity-c/hardware-trap-identity` | `verify` | `liteinst` | `green` | `diverged` |
...
| `backend-parity-c/host-identity` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/host-identity` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/inline-syscall-sites` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/inline-syscall-sites` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/inline-syscall-sites` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/inotify-watch` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/inotify-watch` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/ioctl-fionread` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/ioctl-fionread` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/kcmp-refusal` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/kcmp-refusal` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/kcmp-refusal` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/linkat-flags` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/linkat-flags` | `verify` | `liteinst` | `green` | `diverged` |
...
| `backend-parity-c/lseek-positioning` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/lseek-positioning` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/lseek-positioning` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/mce-kill-refusal` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/mce-kill-refusal` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/mce-kill-refusal` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/membarrier-query` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/membarrier-query` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/membarrier-query` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/memfd-create` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/memfd-create` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/memfd-create` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/mempolicy-default` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/mempolicy-default` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/mempolicy-default` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/mincore-residency` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/mincore-residency` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/mincore-residency` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/mixed-inline-and-libc-syscalls` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/mixed-inline-and-libc-syscalls` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/mixed-inline-and-libc-syscalls` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/mkdir-rmdir` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/mkdir-rmdir` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/mkdir-rmdir` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/mknod-special` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/mknod-special` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/mknod-special` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/mmap-layout-pointer-order` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/mmap-layout-pointer-order` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/mmap-layout-pointer-order` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/msync-writeback` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/msync-writeback` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/name-to-handle-refusal` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/name-to-handle-refusal` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/name-to-handle-refusal` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/no-new-privs-refusal` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/no-new-privs-refusal` | `verify` | `liteinst` | `green` | `diverged` |
...
| `backend-parity-c/numa-node-identity` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/numa-node-identity` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/numa-node-identity` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/o-tmpfile-anon` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/o-tmpfile-anon` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/o-tmpfile-anon` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/openat-flags` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/openat-flags` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/openat-flags` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/openat2-refusal` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/openat2-refusal` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/openat2-refusal` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/path-file-ops` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/path-file-ops` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/path-file-ops` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/personality-domain` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/personality-domain` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/pid-probe` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/pid-probe` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/pid-probe` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/pid-probe` | `verify` | `sabre` | `green` | `diverged` |
| `backend-parity-c/pidfd-open-self` | `verify` | `dbt` | `red` | `measured-and-passed` |
| `backend-parity-c/pidfd-open-self` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/pidfd-open-self` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/pidfd-open-self` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/pipe-capacity` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/pipe-capacity` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/pipe-capacity` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/pipe-capacity-pin` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/pipe-capacity-pin` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/pipe-capacity-pin` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/pipe-ipc` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/pipe-ipc` | `verify` | `liteinst` | `green` | `diverged` |
...
| `backend-parity-c/pipe2-flags` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/pipe2-flags` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/pipe2-flags` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/poll-readiness` | `verify` | `liteinst` | `green` | `diverged` |
...
| `backend-parity-c/prctl-identity` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/prctl-identity` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/prctl-pdeathsig` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/prctl-pdeathsig` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/preadv2-flags` | `verify` | `liteinst` | `green` | `diverged` |
...
| `backend-parity-c/pthread-lifecycle` | `verify` | `liteinst` | `green` | `diverged` |
...
| `backend-parity-c/readdir-entries` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/readdir-entries` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/readdir-entries` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/readdir-order-identity` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/readdir-order-identity` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/readdir-order-identity` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/record-lock` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/record-lock` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/rename-ops` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/rename-ops` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/rename-ops` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/renameat2-flags` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/renameat2-flags` | `verify` | `liteinst` | `green` | `diverged` |
...
| `backend-parity-c/rlimit-identity` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/rlimit-identity` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/rlimit-identity` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/robust-list` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/robust-list` | `verify` | `liteinst` | `green` | `diverged` |
...
| `backend-parity-c/sched-getaffinity-identity` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/sched-getaffinity-identity` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/sched-getaffinity-identity` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/seccomp-refusal` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/seccomp-refusal` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/seccomp-refusal` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/sendfile-copy` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/sendfile-copy` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/sendfile-copy` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/set-tid-address` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/set-tid-address` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/set-tid-address` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/short-io-split-identity` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/short-io-split-identity` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/short-io-split-identity` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/shutdown-socketpair` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/shutdown-socketpair` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/shutdown-socketpair` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/signal-delivery-sequence` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/signal-delivery-sequence` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/signal-waitstatus-identity` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/signal-waitstatus-identity` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/signalfd-create` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/signalfd-create` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/signalfd-create` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/socket-epoll-ordering` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/socket-epoll-ordering` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/socket-epoll-ordering` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/socket-options` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/socket-options` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/socketpair-flags` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/socketpair-flags` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/sockname-unnamed` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/sockname-unnamed` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/stat-metadata-identity` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/stat-metadata-identity` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/stat-metadata-identity` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/statfs-free-determinism` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/statfs-free-determinism` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/statfs-free-determinism` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/static-nolibc-syscall-sites` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/static-nolibc-syscall-sites` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/statx-metadata` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/statx-metadata` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/statx-metadata` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/symlink-ops` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/symlink-ops` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/symlink-ops` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/sync-file-range` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/sync-file-range` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/sync-file-range` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/sysv-ipc-refusal` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/sysv-ipc-refusal` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/sysv-ipc-refusal` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/thp-disable` | `verify` | `liteinst` | `green` | `diverged` |
...
| `backend-parity-c/umask-mode` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/umask-mode` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/umask-mode` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/uname-identity` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/uname-identity` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/uname-identity` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/utimensat-determinism` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/utimensat-determinism` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/utimensat-determinism` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/vectored-file-io` | `verify` | `liteinst` | `green` | `diverged` |
| `backend-parity-c/vectored-file-io` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `backend-parity-c/vectored-io` | `verify` | `kvm` | `green` | `diverged` |
| `backend-parity-c/vectored-io` | `verify` | `liteinst` | `green` | `diverged` |
...
| `bin-c/robust-futex-test` | `verify` | `ptrace` | `red` | `measured-and-passed` |
...
| `c-programs/bpf-enosys` | `verify` | `sabre` | `green` | `diverged` |
...
| `c-programs/dbt-execveat-unsupported` | `verify` | `sabre` | `red` | `diverged` |
...
| `c-programs/dbt-unsupported-syscall` | `verify` | `ptrace` | `red` | `measured-no-verdict` |
...
| `c-programs/memfd-secret-enosys` | `verify` | `sabre` | `green` | `diverged` |
...
| `c-programs/nanosleep-threads-simple` | `verify` | `ptrace` | `red` | `measured-no-verdict` |
...
| `c-programs/netlink-autobind-usersock` | `verify` | `sabre` | `green` | `diverged` |
...
| `c-programs/prodcons-determinism` | `verify` | `kvm` | `red` | `diverged` |
...
| `c-programs/ptrace-seize-eperm` | `verify` | `kvm` | `green` | `measured-and-passed` |
...
| `c-programs/record-replay-file-state-regular-sink` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `c-programs/record-replay-file-state-regular-sink` | `verify` | `sabre` | `green` | `measured-and-passed` |
...
| `c-programs/remap-file-pages-anonymous-enosys` | `verify` | `sabre` | `green` | `diverged` |
...
| `c-programs/resource-determinism` | `verify` | `ptrace` | `red` | `measured-no-verdict` |
...
| `c-programs/sigtimedwait-timeout-0s` | `verify` | `sabre` | `red` | `diverged` |
...
| `c-programs/socket-cookie-udp` | `verify` | `sabre` | `green` | `diverged` |
...
| `c-programs/socket-timestamp-edge-cases` | `verify` | `liteinst` | `red` | `measured-no-verdict` |
| `c-programs/socket-timestamp-edge-cases` | `verify` | `ptrace` | `red` | `measured-no-verdict` |
...
| `data-handling/jq-json-transform` | `verify` | `kvm` | `green` | `diverged` |
...
| `debugger-c/debuggee` | `verify` | `sabre` | `green` | `diverged` |
...
| `determinism-stress/thread-output` | `verify` | `kvm` | `green` | `diverged` |
...
| `determinism-stress-c/pipe-chain` | `verify` | `kvm` | `green` | `measured-and-passed` |
...
| `determinism-stress-c/pipe-prefill` | `verify` | `kvm` | `green` | `measured-and-passed` |
...
| `determinism-stress-c/thread-stress` | `verify` | `sabre` | `red` | `diverged` |
...
| `language-runtimes/example-python-random` | `verify` | `ptrace` | `green` | `diverged` |
...
| `language-runtimes/m4-macro-mkstemp` | `verify` | `kvm` | `green` | `diverged` |
...
| `language-runtimes/python-dict-hash-iteration` | `verify` | `kvm` | `green` | `measured-and-passed` |
| `language-runtimes/python-dict-hash-iteration` | `verify` | `ptrace` | `green` | `measured-and-passed` |
...
| `language-runtimes/python-io-subprocess-time` | `verify` | `kvm` | `green` | `measured-and-passed` |
| `language-runtimes/python-io-subprocess-time` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `language-runtimes/python-random` | `verify` | `kvm` | `green` | `measured-and-passed` |
| `language-runtimes/python-random` | `verify` | `ptrace` | `green` | `diverged` |
| `language-runtimes/ruby-random` | `verify` | `kvm` | `red` | `measured-and-passed` |
...
| `language-runtimes/tcl-rand-clock` | `verify` | `kvm` | `green` | `diverged` |
| `language-runtimes/tcl-rand-clock` | `verify` | `ptrace` | `green` | `measured-and-passed` |
| `shared-futex-c/qemu-exec-init` | `verify` | `ptrace` | `red` | `measured-no-verdict` |
| `shared-futex-c/qemu-hello` | `verify` | `ptrace` | `red` | `measured-no-verdict` |
| `shared-futex-c/qemu-init` | `verify` | `ptrace` | `red` | `measured-no-verdict` |
| `shared-futex-c/qemu-net-init` | `verify` | `ptrace` | `red` | `measured-no-verdict` |
...
| `system-utils/date-nanoseconds` | `verify` | `kvm` | `green` | `diverged` |
...
| `system-utils/openssl-enc` | `verify` | `kvm` | `green` | `diverged` |
...
| `system-utils/shm-coherency-identity` | `verify` | `kvm` | `green` | `measured-and-passed` |
...
| `system-utils/ssh-keygen-ed25519` | `verify` | `kvm` | `green` | `diverged` |
...
| `util-c/pmu-skid` | `verify` | `ptrace` | `red` | `measured-no-verdict` |
